...
part 'topology_spread_constraint.freezed.dart';
part 'topology_spread_constraint.g.dart';

/// TopologySpreadConstraint specifies how to spread matching pods among the given topology.
@freezed
class TopologySpreadConstraint with _$TopologySpreadConstraint {
  const factory TopologySpreadConstraint({
    ...
    @Default('') required String whenUnsatisfiable,
    ...
    @Default(0) required int maxSkew,
