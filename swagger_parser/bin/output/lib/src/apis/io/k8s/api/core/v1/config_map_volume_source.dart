...
part 'config_map_volume_source.freezed.dart';
...
@freezed
class ConfigMapVolumeSource with _$ConfigMapVolumeSource {
  const factory ConfigMapVolumeSource({
