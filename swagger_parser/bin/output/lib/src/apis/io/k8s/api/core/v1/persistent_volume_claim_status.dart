...
part 'persistent_volume_claim_status.freezed.dart';
part 'persistent_volume_claim_status.g.dart';

/// PersistentVolumeClaimStatus is the current status of a persistent volume claim.
@freezed
class PersistentVolumeClaimStatus with _$PersistentVolumeClaimStatus {
  const factory PersistentVolumeClaimStatus({
